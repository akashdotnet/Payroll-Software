    ...
    public partial class Main : System.Web.UI.MasterPage
    {
        ...
        private void LoadMenuList()
        {
            ...
            for (int i = 0; i < _parentItem.Count(); i++)
            {
                ...
                htmlTable.Append("<li class=" + liParentActive + "><a href='../Controllerfile.aspx?OptionID=" + optionID + "|" + gmID + "&GenID=" + gmID + "&ParamInfo='><i class='" + cssClass + "'></i><span>" + optionName + "</span> <i class='fa fa-angle-left pull-right'></i></a>");
