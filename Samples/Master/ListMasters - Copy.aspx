<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ListMasters.aspx.cs" Inherits="Samples.Master.ListMasters" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <form method="post" id="EmployeeInfo" enctype="multipart/form-data" runat="server">
        ...
        <section class="content">
            ...
            </div> <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                                <li class="nav-item">
            ...
            <%--<div id="myChartDiv" style="width:400px;height:200px"></div>--%>
            <div class="row">
                <div class="col-md-12">
                    <!-- Custom Tabs -->
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active" title="Employee Center"><a href="#tab_1" data-toggle="tab"><i class="fa fa-user" id="liEmployee" onclick="EmployeeModule.initEmployee()"></i></a></li>
                            <li title="Salary Template"><a href="#tab_2" data-toggle="tab" id="liSalEmployee" onclick="InitEmpSalaryTemplate.initSalaryTemplate()"><i class="fa fa-calculator"></i></a></li>
                            <%--<li title="Attendance"><a href="#tab_3" data-toggle="tab" onclick="AttendanceModule.loadAttendanceModule()"><i class="fa fa-money"></i></a></li>--%>
                            <li title="Leave"><a href="#tab_4" data-toggle="tab" onclick="LeaveModule.initLeaveMaster()"><i class="fa  fa-sticky-note"></i></a></li>
                            <li title="Attendance"><a href="#tab_5" data-toggle="tab" onclick="AttendanceModule.loadAttendanceModule()"><i class="fa fa-clock-o"></i></a></li>
                            <li title="Leave"><a href="#tab_6" data-toggle="tab"><i class="fa fa-tachometer"></i></a></li>
                            <li title="Loan"><a href="#tab_7" data-toggle="tab"><i class="fa fa-bank"></i></a></li>
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="panel-group" id="accordion">
                                    <div class="panel-primary">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><b>General Information</b></a>
                                            </h4>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        Company 
                                                        <br />
                                                        <asp:DropDownList ID="ddlcompany" runat="server" Width="100%" CssClass="form-control input-sm">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Code
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbEmpCode" CssClass="form-control input-sm " placeholder="Code"></asp:TextBox>

                                                    </div>
                                                    <div class="col-md-3">
                                                        Employee Name 
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbName" CssClass="form-control input-sm " placeholder="Name"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Date of Birth<br />
                                                        <asp:TextBox ID="txtDate" runat="server" CssClass="form-control input-sm dPicker" placeholder="DOB"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        Father/Husband Name
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbFatherName" CssClass="form-control input-sm" placeholder="Father/Husband Name"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        Mother Name<br />
                                                        <asp:TextBox runat="server" ID="tbMotherName" CssClass="form-control input-sm" placeholder="MotherName"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Date of Relieving
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbDateOfRel" CssClass="form-control input-sm dPicker" placeholder="Date of relieving"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Date of Joining   
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbDoj" CssClass="form-control input-sm dPicker" placeholder="DOJ"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Highest Education<br />
                                                        <asp:DropDownList ID="ddlEduacation" runat="server" CssClass="form-control input-sm">
                                                            <asp:ListItem Selected="True" Value="0">--Please Select--</asp:ListItem>
                                                ...
                                                <%-- <div class="form-group hide">
                                                    <div class="col-md-3">
                                                        ...
                                                        <asp:TextBox runat="server" ID="tbNickName" CssClass="" placeholder="Nick name"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Date of Leaving<br />
          
                                                        <asp:TextBox runat="server" ID="tbDol" CssClass=" dPicker" placeholder="DOL"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Reason for Leaving (PF)<br />
           
                                                        <asp:TextBox runat="server" ID="tbRol" CssClass=""></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Reason for Leaving (ESI)<br />
                                                        <asp:TextBox runat="server" ID="tbRolEsi" CssClass="" placeholder="Reason for leaving"></asp:TextBox>
                                                    </div>
                                                </div>--%>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        EPF No           
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbEPFNo" CssClass="form-control input-sm" placeholder="EPF No"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3 ">
                                                        ESIC No         
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbESICNo" CssClass="form-control input-sm" placeholder="ESIC No"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3 ">
                                                        PAN No.   <a href="#" data-toggle="tooltip" title="PAN should be eg.GFHFF7565H"><i class="glyphicon glyphicon-info-sign"></i></a>
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPanNo" CssClass="form-control input-sm" placeholder="Pan No" onfocusout="EmployeeModule.validatePANNo();"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbAdhaarNo" CssClass="form-control input-sm" placeholder="Adhaar Number" onfocusout="EmployeeModule.validateAdhaar();"></asp:TextBox>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        ...
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbUanNo" CssClass="form-control input-sm" placeholder="UAN No" onfocusout="EmployeeModule.validateUANNo();">
                                    ...
                                    <div class="panel-primary">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse2"><b>Mapping</b></a>
                                            </h4>
                                        </div>
                                        <div id="collapse2" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="col-md-3">
                                                        Shift                                                   
       <asp:DropDownList ID="ddlShift" runat="server" Width="100%" CssClass="form-control input-sm">
       </asp:DropDownList>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        Employee Type                                                   
       <asp:DropDownList ID="ddlEmployeeType" runat="server" Width="100%" CssClass="form-control input-sm">
       </asp:DropDownList>
                                                    </div>

                                                    <div class="col-lg-3 ">
                                                        Employee Cateory                                             
       <asp:DropDownList ID="ddlEmployeeCategory" runat="server" Width="100%" CssClass="form-control input-sm">
       </asp:DropDownList>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Project    
     <asp:DropDownList ID="ddlProject" runat="server" Width="100%" CssClass="form-control input-sm">
     </asp:DropDownList>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-3 ">
                                                        Department                                                   
       <asp:DropDownList ID="ddlDepartment" runat="server" Width="100%" CssClass="form-control input-sm">
       </asp:DropDownList>
                                                    </div>

                                                    <div class="col-lg-3 ">
                                                        Designation                                             
       <asp:DropDownList ID="ddlDesignation" runat="server" Width="100%" CssClass="form-control input-sm">
       </asp:DropDownList>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Location                                                
       
     <asp:DropDownList ID="ddlLocation" runat="server" Width="100%" CssClass="form-control input-sm">
     </asp:DropDownList>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        Division                                                   
       <asp:DropDownList ID="ddlDivision" runat="server" Width="100%" CssClass="form-control input-sm">
       </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-lg-3">
                                                        Bank Name                                                        
         <asp:DropDownList ID="ddlBank" runat="server" Width="100%" CssClass="form-control input-sm">
         </asp:DropDownList>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        Bank A/C No       
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbBankAccountNo" CssClass="form-control input-sm" placeholder="Bank Acc/No"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Bank IFSC Code    
                                                          <br />
                                                        <asp:TextBox runat="server" ID="tbBankIfscCode" CssClass="form-control input-sm" placeholder="IFSC Code"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-primary dvAddress">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse4"><b>Address</b></a>
                                            </h4>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="col-lg-3">
                                                        Address Line 1           
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd1" CssClass="form-control input-sm" placeholder="Address Line 1"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Address Line 2 
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd2" CssClass="form-control input-sm" placeholder="Address Line 2"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        District      
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd3" CssClass="form-control input-sm" placeholder="District"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        City      
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd4" CssClass="form-control input-sm" placeholder="City"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-lg-3 ">
                                                        State<br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd5" CssClass="form-control input-sm" placeholder="State"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Pin Code 
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd6" CssClass="form-control input-sm" placeholder="Pin Code"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Mobile Number<br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd7" CssClass="form-control input-sm" placeholder="Mobile Number"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Emergency Contact<br />
                                                        <asp:TextBox runat="server" ID="tbPermanentAdd9" CssClass="form-control input-sm" placeholder="Emergency Contact"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-3 ">
                                                        Address Line 1      
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd1" CssClass="form-control input-sm" placeholder="Address Line 1"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        Address Line 2    
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd2" CssClass="form-control input-sm" placeholder="Address Line 2"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        District           
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd3" CssClass="form-control input-sm" placeholder="District"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        City<br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd4" CssClass="form-control input-sm" placeholder="City"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-lg-3 ">
                                                        State<br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd5" CssClass="form-control input-sm" placeholder="State"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        Pin Code  
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd6" CssClass="form-control input-sm" placeholder="Pin Code"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        Mobile Number<br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd7" CssClass="form-control input-sm" placeholder="Mobile Number"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-3">
                                                        Emergency Contact<br />
                                                        <asp:TextBox runat="server" ID="tbPresentAdd9" CssClass="form-control input-sm" placeholder="Emergency Contact"></asp:TextBox>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="panel-primary dvDrivingLicence ">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse5"><b>Driving Licence & Passport Details</b></a>
                                            </h4>
                                        </div>
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-3 ">
                                                        Licence No. 
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbLicenceNo" CssClass="form-control input-sm" placeholder="Licence No."></asp:TextBox>
                                                    ...
                                                    <div class="col-lg-3 ">
                                                        Date of Issue 
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbLicenceDateOfIssue" CssClass=" form-control input-sm dPicker" ReadOnly="true" placeholder="Date of Issue"></asp:TextBox>

                                                    </div>
                                                    <div class="col-md-3">
                                                        Validity<br />
                                                        <asp:TextBox runat="server" ID="tbLicenceValidity" CssClass=" form-control input-sm dPicker" ReadOnly="true" placeholder="Validity"></asp:TextBox>
                                                    ...
                                                    <div class="col-lg-3 ">
                                                        Issue Authority   
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbLicenceIssueAuthority" CssClass=" form-control input-sm " placeholder="Issue Authority"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-3 ">
                                                        Passport No.      
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPassportNo" CssClass=" form-control input-sm" placeholder="Passport No. "></asp:TextBox>
                                                    ...
                                                    <div class="col-lg-3 ">
                                                        Date of Issue 
                                                        <br />
                                                        <asp:TextBox runat="server" ID="tbPassportDateOfIssue" CssClass="form-control input-sm dPicker" ReadOnly="true" placeholder="Date of Issue"></asp:TextBox>

                                                    </div>
                                                    <div class="col-md-3">
                                                        Validity<br />
                                                        <asp:TextBox runat="server" ID="tbPassportValidity" CssClass="form-control input-sm dPicker" ReadOnly="true" placeholder="Validity"></asp:TextBox>

                                                    </div>
                                                    <div class="col-lg-3 ">
                                                        Place of Issue<br />
                                                        <asp:TextBox runat="server" ID="tbPassportPlaceIssue" CssClass="form-control input-sm" placeholder="Place of Issue"></asp:TextBox>
                                    ...
                                    <div class="panel-primary dvEmployment">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse6" onclick="EmployeeModule.previousEmployment(this)"><b>Previous Employment</b></a>
                                            </h4>
                                            <i class="fa fa-spinner fa-spin spinEmploymentDetails hide" style="font-size: 15px; float: right; margin-top: -25px"></i>
                                        </div>
                                        <div id="collapse6" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <div class="col-lg-12  table-responsive">
                                                        <table id="myTableEmployement" class="order-listEmployement  table">
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" name="CompanyName[]" id="CompanyName" class="form-control input-sm" placeholder="Organization Name"></td>
                                                                <td>
                                                                    <input type="text" name="CompanyAddress[]" id="CompanyAddress" class="form-control input-sm" placeholder="Organization Addess">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="Doj[]" id="Doj" class="dPicker form-control input-sm" readonly placeholder="DOJ"></td>
                                                                <td>
                                                                    <input type="text" name="Dol[]" id="Dol" class="dPicker form-control input-sm" readonly placeholder="DOL">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="ReasonOfLeaving[]" id="ReasonOfLeaving" class="form-control input-sm" placeholder="Reason">
                                                                </td>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="5" style="text-align: left;">
                                                                        <button type="button" id="addrowEmployement" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-plus"></span></button>
                                                                    </td>
                                                                </tr>
                                    ...
                                    <div class="panel-primary dvFamilyDetails ">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse7" onclick="EmployeeModule.familyDetails()"><b>Family Details</b></a>
                                            </h4>
                                            <i class="fa fa-spinner fa-spin spinFamilyDetails hide" style="font-size: 15px; float: right; margin-top: -25px"></i>
                                        </div>
                                        <div id="collapse7" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <div class="form-group table-responsive">

                                                    <table id="myTablefamily" class="order-listfamily table">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select name="familydetailsname[]" class="form-control input-sm">
                                                            ...
                                                            <td>
                                                                <input type="text" name="FamilyMemberName[]" class="form-control input-sm" id="FamilyMemberName" placeholder="Name">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="FamilyMemberAge[]" class="form-control input-sm" id="FamilyMemberAge" placeholder="Age">
                                                            </td>
                                                            <td>
                                                                <input id="FamilyMemberDob" class="dPicker form-control input-sm" name="FamilyMemberDob[]" readonly placeholder="DOB"></td>

                                                            <td>
                                                                <input type="text" name="FamilyMembeAdhaarNo[]" class="form-control input-sm" id="FamilyMembeAdhaarNo" placeholder="Adhaar No">
                                                            </td>
                                                            <td><a class="deleteRow"></a></td>
                                                        </tr>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <td colspan="5" style="text-align: left;">
                                                                    <button type="button" id="addrowfamily" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-plus"></span></button>
                                                                </td>
                                                            </tr>
                                    ...
                                    <div class="panel-primary dvAcademic">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse8" onclick="EmployeeModule.academicDetails()"><b>Academic Details</b></a>
                                            </h4>
                                            <i class="fa fa-spinner fa-spin spinAcademicDetails hide" style="font-size: 15px; float: right; margin-top: -25px"></i>
                                        </div>
                                        <div id="collapse8" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                <div class="form-group table-responsive">
                                                    <table id='data_TableInfo' class="table ">
                                                        <tr>
                                                        ...
                                                        <tr class="appendableDIV">
                                                            <td>
                                                                <input type="text" placeholder="Examination Passed" class="form-control input-sm" />
                                                            </td>
                                                            <td>
                                                                <input type="text" placeholder="Name Of School" class="form-control input-sm" />
                                                            </td>
                                                            <td>
                                                                <input type="text" placeholder="Subjects" class="form-control input-sm" />
                                                            </td>
                                                            <td>
                                                                <select id="EducationMonth2" name="EducationMonth2" class="form-control input-sm">
                                                            ...
                                                            <td>
                                                                <select id="EducationYearE" name="EducationYearE" class="form-control input-sm">
                                                                    <option value="0">--Please Select--</option>
                                                            ...
                                                            <td>
                                                                <input type="text" placeholder="Garde" class="form-control input-sm" />
                                                            </td>

                                                            <td id="dButton">
                                                                <button class="btn btn-primary btn-xs" type="button" onclick="CommonModule.addRow();"><i class="glyphicon glyphicon-plus"></i></button>
                                                                <button class="btn btn-danger btn-xs" type="button" onclick="CommonModule.removeRow(this);"><i class="glyphicon glyphicon-minus"></i></button>
                                    ...
                                    <div class="panel-primary dvSalary">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse9"><b>Salary</b></a>
                                            </h4>
                                        </div>
                ...
                <asp:DropDownList ID="ddlSalaryTemplate" runat="server" Width="100%" onchange="InitEmpSalaryTemplate.onSalaryTemplateChange()" CssClass="form-control input-sm">
                </asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-6">
                                                    </div>
                                    ...
                                    <div class="form-group margin-bottom-none">
                                        ...
                                        <div class="col-sm-1 pull-right">
                                            <button type="submit" class="btn btn-default pull-right btn-block btn-sm" onclick="EmployeeModule.clearControl();">Cancel</button>
                                        </div>
                                        <div class="col-sm-1 pull-left">
                                            <button type="submit" class="btn btn-success pull-right btn-block btn-sm" id="btnSave" onclick="EmployeeModule.createEmployee();">
                                                Save
                                                 <i class="fa fa-spinner fa-spin spinner hide" style="font-size: 10px; float: right"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <br />
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="box">
                                                    ...
                                                    <div id="data" class="box-body"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                            ...
                            <div class="tab-pane" id="tab_2">
                                ...
                                <div class="row" id="dvSalaryTemplate">
                                </div>
                                ...
                                <section class="content">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="box">
                                                <div class="box-header">
                                                    <h3 class="box-title">All Template</h3>
                                                </div>
                                                <div id="templateGrid" class="box-body"></div>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                            ...
                            <div class="tab-pane" id="tab_4">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs">
                                                <li class="active" title="Leave Type"><a href="#tab_leaveType" data-toggle="tab">Leave Type</a></li>
                                                <li title="Leave Apply"><a href="#tab_leaveApply" data-toggle="tab" onclick="LeaveModule.leaveRequest()">Leave Apply</a></li>
                                                <li title="Leave Credit"><a href="#tab_leaveCredit" data-toggle="tab">Leave Credit</a></li>
                                                <li title="Leave Transaction"><a href="#tab_leaveTransaction" data-toggle="tab">Leave Transaction</a></li>
                                                <li title="Leave Process"><a href="#tab_leaveProcess" data-toggle="tab">Leave Process</a></li>
                                                <li title="Leave Detail"><a href="#tab_leaveDetail" data-toggle="tab">Leave Detail</a></li>
                                                <li title="Leave Debit"><a href="#tab_leaveDebit" data-toggle="tab">Leave Debit</a></li>
                                                <li title="Leave Ledger"><a href="#tab_leaveLedger" data-toggle="tab">Leave Ledger</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_leaveType">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Leave Type   
                <asp:DropDownList ID="ddlMasterLeaveType" runat="server" Width="100%" CssClass="form-control input-sm">
                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Employee Type 
                <asp:DropDownList ID="ddlMasterEmployeeType" runat="server" Width="100%" CssClass="form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Designation
           <asp:DropDownList ID="ddlMasterDesignation" runat="server" Width="100%" CssClass="form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Location
                                                      <asp:DropDownList ID="ddlMasterLocation" runat="server" Width="100%" CssClass="form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Department
                                                      <asp:DropDownList ID="ddlMasterDepartment" runat="server" Width="100%" CssClass="form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Project  
                <asp:DropDownList ID="ddlMasterProject" runat="server" Width="100%" CssClass="form-control input-sm">
                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                ...
                <asp:DropDownList ID="ddlMasterLeaveDistributionPeriod" runat="server" Width="100%" CssClass="form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Accrual Period Begin
                                                                 <asp:TextBox runat="server" ID="TextBox5" CssClass="form-control input-sm dPicker"></asp:TextBox>
                                                                <%--<asp:DropDownList ID="ddlMasterAccrualPeriodBegin" runat="server" Width="100%" class="  dPicker">
           </asp:DropDownList>--%>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Accrual Period End
                                                                 <asp:TextBox runat="server" ID="TextBox6" CssClass="form-control input-sm dPicker"></asp:TextBox>
                                                                <%--<asp:DropDownList ID="ddlMasterAccrualPeriodCount" runat="server" Width="100%" class=" ">
                                                      </asp:DropDownList>--%>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Year 
                                                      <asp:DropDownList ID="ddlMasterYear" runat="server" Width="100%" CssClass="form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Leave Per Accrual Period  
                                                                <asp:TextBox runat="server" ID="TextBox1" class=" numberOnly" CssClass="form-control input-sm"></asp:TextBox>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Leave start date
                                            <asp:TextBox runat="server" ID="TextBox2" placeholder="Start Date" CssClass="form-control input-sm dPicker"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                Leave end date
                                                   <asp:TextBox runat="server" ID="TextBox3" CssClass="dPicker form-control input-sm" placeholder="End Date"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-12 text-right">
                                                                ...
                                                                <button class="btn btn-default btn-small" type="button">Clear</button>
                                                            </div>

                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab_leaveApply">
                                                    ...
                                                    <%--<div class="form-group">
                                                            <div class="col-md-12 text-right">
                                                                <button class="btn btn-primary btn-small" type="button">Apply</button>
                                                                <button class="btn btn-default btn-small" type="button">Clear</button>
                                                            </div>

                                                        </div>--%>
                                                </div>
                                                <div class="tab-pane" id="tab_leaveCredit">
                                                </div>
                                                <div class="tab-pane" id="tab_leaveTransaction">
                                                </div>
                                                <div class="tab-pane" id="tab_leaveProcess">
                                                </div>
                                                <div class="tab-pane" id="tab_leaveDetail">
                                                </div>
                                                <div class="tab-pane" id="tab_leaveDebit">
                                                </div>
                                                <div class="tab-pane" id="tab_leaveLedger">
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane" id="tab_5">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="nav-tabs-custom">
                                            <ul class="nav nav-tabs">
                                                <li class="active" title="Attendance entry"><a href="#tab_Attendanceentry" data-toggle="tab" onclick="AttendanceModule.loadAttendanceModule()">Attendance entry</a></li>
                                                <li title="Monthly Attendance"><a href="#tab_MonthlyAttendance" data-toggle="tab" onclick="AttendanceModule.loadMonthlyAttendanceModule()">Monthly Attendance process</a></li>
                                                <li title="Attndance Approval"><a href="#tab_AttndanceApproval" data-toggle="tab" onclick="AttendanceModule.loadMonthlyAttendanceModule()">Attendance approval</a></li>
                                                <li title="Payroll Process"><a href="#tab_PayrollProcess" data-toggle="tab" onclick="AttendanceModule.loadMonthlyAttendanceModule()">Payroll process</a></li>
                                                <li title="Attendance Report"><a href="#tab_Attendance" data-toggle="tab" onclick="AttendanceModule.loadAttendanceModule()">Attendance report</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_Attendanceentry">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                <label>Employee</label>
                                                                <asp:DropDownList ID="DropDownList29" runat="server" Width="100%" CssClass="ddlEmployee form-control input-sm">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Department</label>
                                                                <asp:DropDownList ID="DropDownList30" runat="server" Width="100%" CssClass="ddlAttDepartment form-control input-sm">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Location</label>
                                                                <asp:DropDownList ID="DropDownList31" runat="server" Width="100%" CssClass="ddlAttLocation form-control input-sm ">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Attendance Start Date</label>
                                                                <input id="Text1" class="form-control input-sm dPicker tbAttStartDate" runat="server" placeholder="Start date" value="07/01/2016">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Attendance End Date</label>
                                                                <input id="Text2" class="form-control input-sm dPicker tbAttEndDate" runat="server" placeholder="End date" value="07/29/2016">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <br />
                                                                <button type="button" class=" btn btn-primary pull-left btn-xs" style="float: left" onclick="AttendanceModule.onAttendanceSch(true)"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-12" style="overflow-x: auto;">
                                                                <br />
                                                                <table id="tableAttendanceentry" class="table" cellspacing="0">
                                                                </table>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab_MonthlyAttendance">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Employee  
              <asp:DropDownList ID="DropDownList1" runat="server" Width="100%" class=" ddlEmployee form-control input-sm">
              </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Employee Type 
                <asp:DropDownList ID="DropDownList2" runat="server" Width="100%" class="ddlEmployeeType form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Designation
           <asp:DropDownList ID="DropDownList3" runat="server" Width="100%" class="ddlDesignation form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Location
                                                      <asp:DropDownList ID="DropDownList4" runat="server" Width="100%" class="ddlLocation form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Department
                                                      <asp:DropDownList ID="DropDownList5" runat="server" Width="100%" class=" ddlDepartment form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Project  
                <asp:DropDownList ID="DropDownList6" runat="server" Width="100%" class=" ddlProject form-control input-sm">
                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Year  
              <asp:DropDownList ID="ddlYear" runat="server" Width="100%" class="ddlYear form-control input-sm">
              </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Month
                <asp:DropDownList ID="ddlMonth" runat="server" Width="100%" class="ddlMonth form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Shift
           <asp:DropDownList ID="DropDownList9" runat="server" Width="100%" class="ddlShift form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Division
                                                      <asp:DropDownList ID="DropDownList10" runat="server" Width="100%" class="ddlDivision form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <br />
                                                                <button type="button" class=" btn btn-primary pull-left btn-xs" style="float: left" onclick="AttendanceModule.getMonthlyAttendance(0)"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group dvMonthlyAttendance">
                                                        <button type="button" class=" btn btn-success btn-xl" onclick="AttendanceModule.saveMonthlyAttendance()">Approve </button>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab_AttndanceApproval">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Employee  
              <asp:DropDownList ID="DropDownList11" runat="server" Width="100%" class=" ddlEmployee form-control input-sm">
              </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Employee Type 
                <asp:DropDownList ID="DropDownList12" runat="server" Width="100%" class="ddlEmployeeType form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Designation
           <asp:DropDownList ID="DropDownList13" runat="server" Width="100%" class="ddlDesignation form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Location
                                                      <asp:DropDownList ID="DropDownList14" runat="server" Width="100%" class="ddlLocation form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Department
                                                      <asp:DropDownList ID="DropDownList15" runat="server" Width="100%" class=" ddlDepartment form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Project  
                <asp:DropDownList ID="DropDownList16" runat="server" Width="100%" class=" ddlProject form-control input-sm">
                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Year  
              <asp:DropDownList ID="DropDownList17" runat="server" Width="100%" class="ddlYear form-control input-sm">
              </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Month
                <asp:DropDownList ID="DropDownList18" runat="server" Width="100%" class="ddlMonth form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Shift
           <asp:DropDownList ID="DropDownList19" runat="server" Width="100%" class="ddlShift form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Division
                                                      <asp:DropDownList ID="DropDownList20" runat="server" Width="100%" class="ddlDivision form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <br />
                                                                <button type="button" class=" btn btn-primary pull-left btn-xs" style="float: left" onclick="AttendanceModule.getAttndanceApproval(1)"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        </div>
                                                        </div>
                                                        <br />
                                                        <div class="dvAttApprovaltemplateGrid1"></div>
                                                        <div class="form-group dvAttApproval">
                                                            <button type="button" class=" btn btn-success pull-right btn-xs">Approve Attendance </button>

                                                            <button type="button" class=" btn btn-danger pull-right btn-xs">Reject Attendance </button>
                                                        </div>
                                                    
                                                </div>
                                                <div class="tab-pane" id="tab_PayrollProcess">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Employee  
              <asp:DropDownList ID="DropDownList7" runat="server" Width="100%" class=" ddlEmployee form-control input-sm">
              </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Employee Type 
                <asp:DropDownList ID="DropDownList8" runat="server" Width="100%" class="ddlEmployeeType form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Designation
           <asp:DropDownList ID="DropDownList21" runat="server" Width="100%" class="ddlDesignation form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Location
                                                      <asp:DropDownList ID="DropDownList22" runat="server" Width="100%" class="ddlLocation form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Department
                                                      <asp:DropDownList ID="DropDownList23" runat="server" Width="100%" class=" ddlDepartment form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Project  
                <asp:DropDownList ID="DropDownList24" runat="server" Width="100%" class=" ddlProject form-control input-sm">
                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                Year  
              <asp:DropDownList ID="DropDownList25" runat="server" Width="100%" class="ddlYear form-control input-sm">
              </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Month
                <asp:DropDownList ID="DropDownList26" runat="server" Width="100%" class="ddlMonth form-control input-sm">
                </asp:DropDownList>

                                                            </div>
                                                            <div class="col-md-2">
                                                                Shift
           <asp:DropDownList ID="DropDownList27" runat="server" Width="100%" class="ddlShift form-control input-sm">
           </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                Division
                                                      <asp:DropDownList ID="DropDownList28" runat="server" Width="100%" class="ddlDivision form-control input-sm">
                                                      </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <br />
                                                                <button type="button" class=" btn btn-primary pull-left btn-xs" style="float: left" onclick="AttendanceModule.getMonthlyAttendance(1)"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        </div>
                                                        <br />
                                                        <div class="form-group">
                                                            <div class="box-body templateGrid1"></div>
                                                        </div>
                                                        <div class="form-group dvAttApproval">
                                                            <center>
                                                                 <button type="button" class=" btn btn-success pull-right btn-xs">Genrate Payroll </button>
                                                            
                                                             <button type="button" class=" btn btn-danger pull-right btn-xs">Reject Payroll </button>
                                                             </center>
                                                ...
                                                <div class="tab-pane" id="tab_Attendance">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <div class="col-md-2">
                                                                <label>Employee</label>
                                                                <asp:DropDownList ID="ddlEmployee" runat="server" Width="100%" CssClass="ddlEmployee form-control input-sm">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Department</label>
                                                                <asp:DropDownList ID="ddlAttDepartment" runat="server" Width="100%" CssClass="ddlAttDepartment form-control input-sm">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Location</label>
                                                                <asp:DropDownList ID="ddlAttLocation" runat="server" Width="100%" CssClass="ddlAttLocation form-control input-sm">
                                                                </asp:DropDownList>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Attendance Start Date</label>
                                                                <input id="tbAttStartDate" class="form-control input-sm dPicker tbAttStartDate" runat="server" placeholder="Start date" value="07/01/2016">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <label>Attendance End Date</label>
                                                                <input id="tbAttEndDate" class="form-control input-sm dPicker tbAttEndDate" runat="server" placeholder="End date" value="07/29/2016">
                                                            </div>
                                                            <div class="col-md-2">
                                                                <br />
                                                                <button type="button" class=" btn btn-primary pull-left btn-xs" style="float: left" onclick="AttendanceModule.onAttendanceSch(false)"><i class="fa fa-search"></i></button>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-12 table-responsive" style="overflow-x: auto;">
                                                                <br />
                                                                <table id="tableAttendance" class="table" cellspacing="0">
                                                                </table>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="alert alert-danger alert-dismissible fade in dvTemplateNoRecords" style="display: none">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <strong>No Records</strong>
                                </div>
                            </div>
            ...
            <%--<div class="row" id="piechart" style="width: 300px; height: 200px;"></div>--%>
        </section>
    </form>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptsSection" runat="server">
    ...
    <script type="text/javascript">
        ...
        var LeaveModule = (function () {
            var _url = "../api/Leave/GetEmployeeList";
            var initLeaveMaster = function () {
                CommonModule.progressBarShow();
            ...
            var leaveRequest = function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        + '<table class="table" id="tableLeaveRequest">                                            '
                        + '<thead>'
                        + '<tr>                                                                                                              '
                        ...
                        $.each(ddlArray, function (i, v) {
                            ...
                            + '<td>' + nameWithCode + '</td>'
                            + '<td><input type="text" class="form-control input-sm dLeavePicker" value="' + date + '" readonly></td>                                                                                                 '
                            + '<td><select class="lType form-control input-sm"></select></td>                                                                       '
                            + '<td><input type="text" class="form-control input-sm dLeavePicker" value="' + date + '" readonly></td>                                     '
                            + '<td><input type="text" class="form-control input-sm dLeavePicker" value="' + date + '" readonly></td>                                          '
        ...
        var AttendanceModule = (function () {
            ...
            var onAttendanceSch = function (isEntry) {
                ...
                var url = "../api/Attendance/GtAttendance";
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: "json",
                        ...
                        for (var i = 0; i < data.List.length; i++) {
                            ...
                            for (var colIndex = 0; colIndex < cols.length; colIndex++) {
                                ...
                                if (data.List[i][cols[0]] === data.List[i][cols[colIndex]]) {
                                    text = '<div class="user-panel" style="width:180px;height:30px">'
                                    + '<div class="pull-left image" >'
                                    + '<img src="../../../AdminLTE-master/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">'
                                    + '</div> '
                                    + '<div class="info">'
                                    + '<label  style="color:black">' + data.List[i][cols[colIndex]] + '</label>'
                                    + '</div>'
                                    + '</div>';
                                    ...
                                    // var isDis = val === 'P' ? 'disabled' : '';
                                    if (isEntry) {
                                        var isDis = val === 'P' ? 'disabled' : '';
                                        text += '<select style="width:50px" id="ddlPresentStatus' + colIndex + '" att-date="' + cols[colIndex] + '" attr-employee-id="' + cols[colIndex] + '"  ' + isDis + '><option value="P">P</option><option value="A">A</option><option value="L">L</option><option value="NA">N/A</option></select><br/>'
                                        //  text +='<input type="text">'
                                        row.append($('<td />').html(text));
                                        row.find('select#ddlPresentStatus' + colIndex + ' option[value=' + val + ']').attr('selected', 'selected');
                                    }
                                    else {
                                        if (val === 'P')
            ...
            var getMonthlyAttendance = function (entryLock) {
                ...
                CommonModule.progressBarShow();
                var sMonthly = true;
                var tablMonthlyAttendance = 'tablMonthlyAttendance';
                var lstData = [employeeId, employeeTypeId, designationId, sMonthly, locationId, departmentId,
                projectId, shiftId, divisionId, month, year, entryLock, tablMonthlyAttendance];
                var url = "../api/Attendance/GtAttendance";
                //  var url = "../api/Attendance/GetMonthly";
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType: "json",
            ...
            var getAttndanceApproval = function (entryLock) {
                ...
                CommonModule.progressBarShow();
                var sMonthly = true;
                var tablePayrollPocess = 'tablePayrollPocess';
                var lstData = [employeeId, employeeTypeId, designationId, sMonthly, locationId, departmentId,
                projectId, shiftId, divisionId, month, year, entryLock, tablePayrollPocess];
                var url = "../api/Attendance/GtAttendance";
                $.ajax({
                    url: url,
                    type: 'POST',
        ...
        var InitEmpSalaryTemplate = (function () {
            ...
            var initSalaryTemplate = function () {
                ...
                $.ajax({
                    ...
                    var html = '<div class="form-group">                                         '
                      ...
                      + '<div class="col-md-3">                                          '
                    + 'Define Salary Template Name <input id="tbSalaryTemplateName"                                 '
                    + 'placeholder="Define Salary Template Name" id="tbSalaryTemplate"/> '
                    + '</div>                                                           '
                    + '<div class="col-md-3">                                          '
                    + ' Active  </br><input id="chkIsActive" type="checkbox" checked="checked"/>                               '
                    + '</div>                                                           '
                    + '</div>                                                       '
                    + '<div class="col-lg-12 table-responsive"><br/>'
                    + '<table class="table" id="tableSalaryTemplate">                                            '
                    + '<thead>'
                    + '<tr>                                                                                                              '
                    + '<td colspan="7">                                                                        '
                    + '<button type="button" class="btnSaveTemplate btn btn-success pull-right btn-block btn-sm" style="width:150px" onclick="InitEmpSalaryTemplate.createSalaryTemplate(this)">Save</button>'
                    + '</td>                                                                                                             '
                    + '</tr>                                                                                                             '
                    + '<tr>                                                                                                              '
                    ...
                    $.each(data.List, function (i, v) {
                        html += '<tr>'
                        + '<td> <input class="checkbox" type="checkbox" name="check[]" id="' + v.ID + '"></td>'
                        + '<td>' + v.MAINDESCR + '</td>'
                        ...
                        + '<td><input type="text" class=" " placeholder="Default Value" value="0.00"></td>                                     '
            ...
            var onSalaryTemplateChange = function () {
                ...
                $.ajax({
                    url: "/api/EmployeeTemplate/" + selectedVal,
                    type: 'GET',
                    success: function (data) {
                        var deductionAmt = 0;
                        var additionalAmt = 0;
                        ...
                        var html = '<div class="table-responsive"><table class="table" id="tableSalaryTemplate"><thead><tr><th>Payroll Item</th><th>Payroll Type</th><th>Default Value</th><th>Value Type</th><th>Applicable On</th><th>Active</th><th>Final Value</th></tr><thead><tbody>';
        ...
        var EmployeeModule = (function () {
            ...
            var previousEmployment = function () {
                ...
                var _url = "../api/PIS/GetEmployment/" + employeeId;
                CommonModule.progressBarShow();
                //EmployeeModule.hideEmployeeDivs();
                $.ajax({
                    url: _url,
        ...
        var CommonModule = (function () {
            var _url = "../api/Master/GetMaster";
            var _urlEmployeeList = "../api/Master/GetEmployeeList";
            ...
            //    $.ajax({
            //        url: _urlEmployeeList + "/" + 1,
            //        type: 'GET',
            //        async: false,
            //        success: function (data) {
            //            var ddlEmployee = $("#FeaturedContent_ddlEmployee");
        ...
        $(function () {
            ...
            $("#addrowEmployement").on("click", function () {
                ...
                cols += '<td><input class="form-control input-sm" type="text" name="CompanyName' + counterEmpl + '" id="CompanyName' + counterEmpl + '"class=" " placeholder="Organization Name"/></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="CompanyAddress' + counterEmpl + '" id="CompanyAddress' + counterEmpl + '" class=" " placeholder="Organization Addess"/></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="Doj" class="dPickerEmPDt  " id="Doj" readonly placeholder="DOJ"/></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="Dol" class="dPickerEmPDt  " id="Dol" readonly placeholder="DOL"/></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="ReasonOfLeaving' + counterEmpl + '" class=" " id="ReasonOfLeaving' + counterEmpl + '" placeholder="Reason"/></td>';
                cols += '<td><button type="button" id="addrow" class="ibtnDelEmployement btn btn-danger btn-xs" ><span class="glyphicon glyphicon-minus"></span></button></td>';
                newRow.append(cols);
            ...
            $("#addrowfamily").on("click", function () {
                ...
                var newRow = $("<tr>");
                var cols = "";
                cols += '<td><select class="form-control input-sm" name="familydetailsname' + counter2 + '"  class=" "><option value="0" selected="selected">--Select--</option>   <option value="5" >Father</option>    <option value="6">Mother</option>    <option value="1">Wife</option>    <option value="2">Husband</option>    <option value="3">Son</option>    <option value="4">Daughter</option>    <option value="8">Brother</option>    <option value="7">Sister</option>                <option value="9">Others</option></select></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="FamilyMemberName' + counter2 + '" class=" "  id="FamilyMemberName' + counter2 + '" placeholder="Name"/></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="FamilyMemberAge' + counter2 + '"class=" " id="FamilyMemberAge' + counter2 + '" placeholder="Age"/></td>';
                cols += '<td><input class="form-control input-sm" id="FamilyMemberDob' + counter2 + '" class="fMemberDob  " name="FamilyMemberDob' + counter2 + '" readonly placeholder="DOB"/></td>';
                cols += '<td><input class="form-control input-sm" type="text" name="FamilyMembeAdhaarNo' + counter2 + '"class=" " id="FamilyMembeAdhaarNo' + counter2 + '" placeholder="Adhaar No"/></td>';
                cols += '<td><button type="button" id="addrowPro" class="ibtnDelfamily btn btn-danger btn-xs"><span class="glyphicon glyphicon-minus"></span></button></td>';
                newRow.append(cols);
            ...
            //    select case when gender=0 then 'N/A'
            //    when gender =1 then 'Male'
            //else 'Female' end, COUNT(code) 
            //    from employee E group by gender
        });
    </script>
    <script type="text/javascript">
